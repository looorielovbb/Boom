 ...
 */
@SuppressWarnings("ALL") public class PackageUtils {
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        ShellUtils.CommandResult commandResult = ShellUtils
                .execCommand(command.toString(), !isSystemApplication(context), true);
    ...
    public static int getInstallLocation() {
        ShellUtils.CommandResult commandResult = ShellUtils
                .execCommand("LD_LIBRARY_PATH=/vendor/lib:/system/lib pm get-install-location",
                             false, true);
