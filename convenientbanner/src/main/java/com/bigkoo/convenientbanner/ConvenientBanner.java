...
public class ConvenientBanner<T> extends RelativeLayout {
    ...
    private final ArrayList<ImageView> mPointViews = new ArrayList<ImageView>();
    ...
    private AdSwitchTask<T> adSwitchTask;
    ...
    public ConvenientBanner<T> setLayoutManager(RecyclerView.LayoutManager layoutManager) {
     ...
     * 设置翻页监听器
     *
     * @param onPageChangeListener 页面变化监听
     * @return 轮播view
     */
    public ConvenientBanner<T> setOnPageChangeListener(OnPageChangeListener onPageChangeListener) {
     ...
     */
    public ConvenientBanner<T> setOnItemClickListener(final OnItemClickListener onItemClickListener) {
     ...
     * @return 轮播View
     */
    public ConvenientBanner<T> setCurrentItem(int position, boolean smoothScroll) {
     ...
     * @return 轮播View
     */
    public ConvenientBanner<T> setFirstItemPos(int position) {
     ...
     * @return 轮播View
     */
    public ConvenientBanner<T> setPageIndicatorAlign(PageIndicatorAlign align) {
    ...
    public ConvenientBanner<T> startTurning() {
    ...
    static class AdSwitchTask<T> implements Runnable {

        private final WeakReference<ConvenientBanner<T>> reference;

        AdSwitchTask(ConvenientBanner<T> convenientBanner) {
            this.reference = new WeakReference<>(convenientBanner);
        }

        @Override
        public void run() {
            ConvenientBanner<T> convenientBanner = reference.get();
