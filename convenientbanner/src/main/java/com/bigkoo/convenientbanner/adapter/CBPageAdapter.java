...
public class CBPageAdapter<T> extends RecyclerView.Adapter<Holder<T>>{
    ...
    private final CBViewHolderCreator<T> creator;
    private final CBPageAdapterHelper helper;
    private boolean canLoop;
    private OnItemClickListener onItemClickListener;

    public CBPageAdapter(CBViewHolderCreator<T> creator, List<T> datas, boolean canLoop) {
